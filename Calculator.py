...
btn_div=Button(root,text="÷",font=("ariel",12, "bold"),bd=12,height=2,width=6,command=lambda:btnClick('/'))#by holding Alt key press number 246, division symbol will get ÷.
